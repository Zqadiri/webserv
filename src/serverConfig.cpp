...
std::string						serverConfig::getRoot(void){return this->_root;}
std::string						serverConfig::getIndex(void){return this->_index;}
bool							serverConfig::getAutoindex(void){return this->_autoindex;}
std::string						serverConfig::getRedirectPath(void){return this->_redirect.path;}
int			 					serverConfig::getRedirectCode(void){return this->_redirect.code;}
std::string						serverConfig::getErrorPagePath(void){return this->_errorPages.path;}
int								serverConfig::getErrorPageCode(void){return this->_errorPages.code;}
